    ...
    <SiteLayout>
      <section className="container mx-auto max-w-xl px-4 py-12 text-center">
        ...
        <Card className="mt-6 rounded-3xl p-8">
          <div className="rounded-2xl bg-cream/60 p-4 text-left"><div className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Buyer name</div><div className="mt-1 text-2xl font-bold">{buyerName}</div></div>
        ...
        <Button asChild className="mt-6 rounded-full"><Link to="/dashboard">Go to my orders</Link></Button>
      </section>
    </SiteLayout>
  );
}
