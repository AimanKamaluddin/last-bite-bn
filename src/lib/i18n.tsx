...
const translations = {
  en: {
    ...
    foodAvailableToday: "Food available today in Brunei",
    heroTitleStart: "Rescue delicious food",
    heroTitleHighlight: "before it's gone.",
    heroBody: "Find surplus meals, bakery items, desserts, coffee and drinks from local businesses. Reserve in seconds, collect during the pickup window.",
    reserveNow: "Reserve Now",
    pickupToday: "Pickup today",
    shortPickupWindows: "Short pickup windows.",
    payLess: "Pay less",
    discountedLocalFood: "Discounted local food.",
    ...
    howItWorksSubtitle: "Choose an offer, reserve it, and collect during the pickup window.",
    discover: "Discover",
    discoverBody: "See food available today.",
    reserveStep: "Reserve",
    ...
    featuredMerchantsSubtitle: "Local businesses offering surplus food today.",
    viewTodaysOffers: "View today's offers",
    whyPeopleLove: "Why people love Last Bite",
    forCustomers: "For customers",
    forBusinessesCard: "For businesses",
    customerBenefit1: "See available food immediately",
    customerBenefit2: "Reserve before pickup windows close",
    customerBenefit3: "Discover new local favourites",
    customerBenefit4: "Save money on meals, drinks and desserts",
    businessBenefit1: "List unsold inventory quickly",
    ...
    foodWasteBody: "Last Bite connects customers with surplus food from local businesses, making it easier to support merchants while giving good food another chance.",
    ...
    faqKindA: "It depends on what each merchant has available. It could be a single item, a meal, a drink, a dessert, or a bundle.",
  ...
  ms: {
    ...
    foodAvailableToday: "Makanan tersedia hari ini di Brunei",
    heroTitleStart: "Selamatkan makanan sedap",
    heroTitleHighlight: "sebelum habis.",
    heroBody: "Cari lebihan makanan, roti, pencuci mulut, kopi dan minuman daripada perniagaan tempatan. Tempah dalam beberapa saat dan ambil dalam waktu pengambilan.",
    reserveNow: "Tempah Sekarang",
    pickupToday: "Ambil hari ini",
    shortPickupWindows: "Waktu pengambilan singkat.",
    payLess: "Bayar kurang",
    discountedLocalFood: "Makanan tempatan berdiskaun.",
    ...
    howItWorksSubtitle: "Pilih tawaran, tempah, dan ambil dalam waktu pengambilan.",
    discover: "Cari",
    discoverBody: "Lihat makanan yang tersedia hari ini.",
    reserveStep: "Tempah",
    ...
    featuredMerchantsSubtitle: "Perniagaan tempatan yang menawarkan lebihan makanan hari ini.",
    ...
    customerBenefit1: "Lihat makanan tersedia dengan segera",
    customerBenefit2: "Tempah sebelum waktu pengambilan tamat",
    customerBenefit3: "Cari kegemaran tempatan baharu",
    customerBenefit4: "Jimat untuk makanan, minuman dan pencuci mulut",
    businessBenefit1: "Senaraikan stok tidak terjual dengan cepat",
    ...
    foodWasteBody: "Last Bite menghubungkan pelanggan dengan lebihan makanan daripada perniagaan tempatan, memudahkan sokongan kepada peniaga sambil memberi makanan baik peluang kedua.",
    faq: "Soalan lazim",
    ...
    faqKindA: "Ia bergantung kepada apa yang tersedia daripada setiap peniaga. Ia boleh jadi satu item, satu hidangan, minuman, pencuci mulut atau bungkusan.",
